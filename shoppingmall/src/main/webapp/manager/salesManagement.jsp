...
<div class="tab-pane fade" id="sales-management">
	...
	<ul class="nav nav-pills mb-3 bottomNav-managerPage">
		<li class="nav-item"><a class="nav-link active"
			data-toggle="pill" href="#pills-home-daily-sales" aria-selected="true">일일 매출 관리</a></li>
		<li class="nav-item"><a class="nav-link"
			data-toggle="pill" href="#pills-profile-monthly-sales" aria-selected="false">월별 매출 관리</a></li>
	</ul>
